      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              <div className="text-xl font-bold gradient-text">WebToAPK</div>
            </Link>
            <p className="text-gray-600 mb-4">
              Transform any website into a native Android application with just a few clicks.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/#features" className="text-gray-600 hover:text-purple-600 transition-colors">Features</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/docs" className="text-gray-600 hover:text-purple-600 transition-colors">Documentation</Link></li>
              <li><Link to="/guides" className="text-gray-600 hover:text-purple-600 transition-colors">Guides</Link></li>
        ...
        <div className="border-t border-gray-200 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col items-center md:items-start">
            <p className="text-gray-500 text-sm">© {new Date().getFullYear()} WebToAPK. All rights reserved.</p>
            <p className="text-gray-500 text-sm mt-1">By <a href="https://www.facebook.com/jasimuddinevan" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-800 transition-colors">Jasim Uddin</a></p>
          </div>
